...
<script type="text/javascript">
	var config = {
		...
		size: {
			contentWidth: 1350 /* 지정된 본문영역의 넓이가 있을 경우에 설정 */
		}
	};
...
<textarea id="sample_contents_source" style="display:none;">
	...
	<p>
		<a href="http://cfile297.uf.daum.net/attach/207C8C1B4AA4F5DC01A644"><img src="daumeditor/images/icon/editor/p_gif_s.gif"/> editor_bi.gif</a>
	</p>
</textarea>
<script type="text/javascript">
