...
function selectMenuItem(id, attr) {
	...
	<div class="lnbArea">
		...
		<ul class="ct02" id="bbsToggle">
			...
			<li><a id="bbs02" href="javascript:selectMenuItem('bbs02', this);" onfocus="this.blur();">댓글</a></li>
		...
		<ul class="ct02" id="blogToggle">
			...
			<li><a id="blog02" href="javascript:selectMenuItem('blog02', this);" onfocus="this.blur();">댓글</a></li>
			<li><a id="blog03" href="javascript:selectMenuItem('blog03', this);" onfocus="this.blur();">방명록</a></li>
